    ...
    { actionListPage?: (
      { detailsMainTop?: Array<(
        ...
        { id?: string | null, heading?: string | null, helpText?: string | null, layout?: string | null, blocks?: Array<(
          ...
          { id?: string | null }
          & { __typename?: 'PageChooserBlock' | 'PageLinkBlock' | 'PlanFilterBlock' | 'PrimaryOrganizationFilterBlock' | 'QuestionAnswerBlock' | 'QuestionBlock' | 'RawHTMLBlock' | 'RegexBlock' | 'RelatedIndicatorsBlock' | 'RelatedPlanListBlock' | 'ReportTypeFieldChooserBlock' | 'ResponsiblePartyFilterBlock' | 'RichTextBlock' | 'StaticBlock' | 'StreamBlock' | 'StreamFieldBlock' | 'StructBlock' | 'TextBlock' | 'TimeBlock' | 'URLBlock' }
        ) | (
          { id?: string | null, attributeType: (
            { id: string, format: AttributeTypeFormat, name: string, identifier: string, helpText: string, showChoiceNames: boolean, hasZeroOption: boolean, choiceOptions: Array<(
              { id: string, identifier: string }
...
type StreamFieldFragment_94vjfknj9x2KTpW4es_0ZmaEyGxecDrQmA9sNnxjrM_Fragment = (
  { id?: string | null, blockType: string, field: string }
  & { __typename?: 'DateTimeBlock' | 'DecimalBlock' | 'DocumentChooserBlock' | 'EmailBlock' | 'EmbedBlock' | 'FloatBlock' | 'ImageChooserBlock' | 'IndicatorHighlightsBlock' | 'IntegerBlock' | 'PageChooserBlock' | 'PageLinkBlock' | 'PlanFilterBlock' | 'PrimaryOrganizationFilterBlock' | 'QuestionBlock' | 'RawHTMLBlock' | 'RegexBlock' | 'RelatedIndicatorsBlock' | 'RelatedPlanListBlock' | 'ReportComparisonBlock' | 'ReportTypeFieldChooserBlock' }
);
...
type StreamFieldFragment_IndicatorShowcaseBlock_Fragment = (
  { title?: string | null, body?: string | null, id?: string | null, blockType: string, field: string, blocks: Array<(
    ...
    { id?: string | null }
    & { __typename: 'IndicatorHighlightsBlock' | 'IndicatorShowcaseBlock' | 'IntegerBlock' | 'PageChooserBlock' | 'PageLinkBlock' | 'PlanFilterBlock' | 'PrimaryOrganizationFilterBlock' | 'QuestionAnswerBlock' | 'QuestionBlock' | 'RawHTMLBlock' | 'RegexBlock' | 'RelatedIndicatorsBlock' | 'RelatedPlanListBlock' | 'ReportComparisonBlock' | 'ReportTypeFieldChooserBlock' | 'ResponsiblePartyFilterBlock' | 'RichTextBlock' | 'StaticBlock' | 'StreamBlock' | 'StreamFieldBlock' }
  ) | (
    { id?: string | null }
    ...
    { blockType: string }
    & { __typename?: 'IndicatorHighlightsBlock' | 'IndicatorShowcaseBlock' | 'IntegerBlock' | 'PageChooserBlock' | 'PlanFilterBlock' | 'PrimaryOrganizationFilterBlock' | 'QuestionAnswerBlock' | 'QuestionBlock' | 'RawHTMLBlock' | 'RegexBlock' | 'RelatedIndicatorsBlock' | 'RelatedPlanListBlock' | 'ReportComparisonBlock' | 'ReportTypeFieldChooserBlock' | 'ResponsiblePartyFilterBlock' | 'RichTextBlock' | 'StaticBlock' | 'StreamBlock' | 'StreamFieldBlock' | 'StructBlock' }
  ) | (
    { blockType: string }
    & { __typename?: 'TextBlock' | 'TimeBlock' | 'URLBlock' }
  ) | (
...
export type ActionFragmentFragment = (
  { id: string, identifier: string, name: string, viewUrl?: string, color?: string | null, completion?: number | null, officialName?: string | null, updatedAt: any, scheduleContinuous: boolean, startDate?: any | null, endDate?: any | null, order: number, status?: (
    ...
    { identifier: ActionStatusSummaryIdentifier, label: string, color: string }
    & { __typename?: 'ActionStatusSummary' }
  ), timeliness: (
    { identifier: ActionTimelinessIdentifier }
    & { __typename?: 'ActionTimeliness' }
...
type ActionListFilter_Tp2TgUnxhJgMndE6CdIdBpBGwJQjBIhfEkVgHogxhw_Fragment = (
  { field: string, id?: string | null }
...
type ActionListFilter_LfKaWDjlr7medFhuJfC6C8AqdBaw89vPv2o027mLliq_Fragment = (
  { field: string, id?: string | null }
...
export type ActionListFilterFragment = ActionListFilter_IhjBBwez7fLS40GnTtqRZjjy0Kv1vAh93c8Pfw7sak_Fragment | ActionListFilter_Yd6843xP2XelxNnPKdcDbk203MDs5Q6T1Tb6rBhv7pY_Fragment | ActionListFilter_Tp2TgUnxhJgMndE6CdIdBpBGwJQjBIhfEkVgHogxhw_Fragment | ActionListFilter_LfKaWDjlr7medFhuJfC6C8AqdBaw89vPv2o027mLliq_Fragment | ActionListFilter_TimeBlock_UrlBlock_Fragment | ActionListFilter_ActionAttributeTypeFilterBlock_Fragment | ActionListFilter_CategoryTypeFilterBlock_Fragment;
