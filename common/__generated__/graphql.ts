...
type StreamFieldFragment_RdO1kQdxfpLeR1IImRc0TxMtSqX9hErCYfFRbGmBvmk_Fragment = (
  { id?: string | null, blockType: string, field: string }
  & { __typename?: 'PageLinkBlock' | 'PrimaryOrganizationFilterBlock' | 'QuestionBlock' | 'RawHTMLBlock' | 'RegexBlock' | 'RelatedIndicatorsBlock' | 'RelatedPlanListBlock' | 'ReportFieldBlock' | 'ResponsiblePartyFilterBlock' | 'StaticBlock' | 'StreamBlock' | 'StreamFieldBlock' | 'StructBlock' | 'TimeBlock' | 'URLBlock' }
);
...
type StreamFieldFragment_IndicatorShowcaseBlock_Fragment = (
  { title?: string | null, body?: string | null, id?: string | null, blockType: string, field: string, blocks: Array<(
    ...
    { id?: string | null }
    & { __typename: 'RelatedPlanListBlock' | 'ReportFieldBlock' | 'ResponsiblePartyFilterBlock' | 'RichTextBlock' | 'StaticBlock' | 'StreamBlock' | 'StreamFieldBlock' | 'StructBlock' | 'TextBlock' | 'TimeBlock' | 'URLBlock' }
  )>, indicator?: (
...
type ActionListFilter_0XnGoD0jo7V9SOsz0UjKkcXnT5a6EpAyBvt7D6I5Lg_Fragment = (
  { field: string, id?: string | null }
...
export type ActionListFilterFragment = ActionListFilter_MKdy3LuMCbeAzQtWbDcoyh2oBc99FxVy1_96RiTw4_Fragment | ActionListFilter_3Q2uZIaWq3pYvGgAi1beTyz0Bj6ehhNvuXAp9zEzg_Fragment | ActionListFilter_6hRu27VuwcHs6qGUiEa3AOxSpRaNnUgov9YEzQsWRgk_Fragment | ActionListFilter_0XnGoD0jo7V9SOsz0UjKkcXnT5a6EpAyBvt7D6I5Lg_Fragment | ActionListFilter_ActionAttributeTypeFilterBlock_Fragment | ActionListFilter_CategoryTypeFilterBlock_Fragment;
