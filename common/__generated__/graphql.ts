...
export type ActionTask = {
  ...
  commentSvFi?: Maybe<Scalars['String']>;
...
export type MonitoringQualityPoint = {
  ...
  descriptionNoSvFi: Scalars['String'];
  ...
  descriptionYesSvFi: Scalars['String'];
  i18n?: Maybe<Scalars['JSONString']>;
  id: Scalars['ID'];
  identifier: Scalars['String'];
...
type ActionListFilter_PN2D9yJqZ21vuzKhOrYz_2AXhf4cCzRfWo9npewCI_Fragment = (
  { field: string, id?: string | null }
...
type ActionListFilter_IrrLywreTjoZXkWBoTf7Nem6A31Srb0x3aGh3z2Os10_Fragment = (
  { field: string, id?: string | null }
...
type StreamFieldFragment_6Cs4bL8Tw8Ym6vwKZdBCrAKszb66zfLr26B1iObfGrs_Fragment = (
  { id?: string | null, blockType: string, field: string }
  & { __typename?: 'CategoryTypeFilterBlock' | 'ContinuousActionFilterBlock' | 'DateBlock' | 'DateTimeBlock' | 'DecimalBlock' | 'DocumentChooserBlock' | 'EmailBlock' | 'EmbedBlock' | 'FloatBlock' | 'IdentifierColumnBlock' | 'ImageChooserBlock' | 'ImpactColumnBlock' | 'ImplementationPhaseColumnBlock' | 'IndicatorHighlightsBlock' | 'IndicatorsColumnBlock' | 'IntegerBlock' | 'NameColumnBlock' | 'OrganizationColumnBlock' | 'PageChooserBlock' | 'PageLinkBlock' }
);

type StreamFieldFragment_DkrLm6Ngga_73AZg70vHtRZk9zS2UOaKaxkDybHyK_Fragment = (
  { id?: string | null, blockType: string, field: string }
  & { __typename?: 'PlanFilterBlock' | 'PrimaryOrganizationFilterBlock' | 'QuestionBlock' | 'RawHTMLBlock' | 'RegexBlock' | 'RelatedIndicatorsBlock' | 'RelatedPlanListBlock' | 'ReportComparisonBlock' | 'ReportTypeFieldChooserBlock' | 'ResponsiblePartiesColumnBlock' | 'ResponsiblePartyFilterBlock' | 'StaticBlock' | 'StatusColumnBlock' | 'StreamBlock' | 'StreamFieldBlock' | 'StructBlock' | 'TasksColumnBlock' | 'TimeBlock' | 'URLBlock' | 'UpdatedAtColumnBlock' }
);
...
type StreamFieldFragment_IndicatorShowcaseBlock_Fragment = (
  { title?: string | null, body?: string | null, id?: string | null, blockType: string, field: string, blocks: Array<(
    ...
    { blockType: string }
    & { __typename?: 'IdentifierColumnBlock' | 'ImageChooserBlock' | 'ImpactColumnBlock' | 'ImplementationPhaseColumnBlock' | 'IndicatorBlock' | 'IndicatorGroupBlock' | 'IndicatorHighlightsBlock' | 'IndicatorShowcaseBlock' | 'IndicatorsColumnBlock' | 'IntegerBlock' | 'LargeImageBlock' | 'NameColumnBlock' | 'OrganizationColumnBlock' | 'PageChooserBlock' | 'PlanFilterBlock' | 'PrimaryOrganizationFilterBlock' | 'QuestionAnswerBlock' | 'QuestionBlock' | 'RawHTMLBlock' | 'RegexBlock' }
  ) | (
    { blockType: string }
    & { __typename?: 'RelatedIndicatorsBlock' | 'RelatedPlanListBlock' | 'ReportComparisonBlock' | 'ReportTypeFieldChooserBlock' | 'ResponsiblePartiesColumnBlock' | 'ResponsiblePartyFilterBlock' | 'RichTextBlock' | 'StaticBlock' | 'StatusColumnBlock' | 'StreamBlock' | 'StreamFieldBlock' | 'StructBlock' | 'TasksColumnBlock' | 'TextBlock' | 'TimeBlock' | 'URLBlock' | 'UpdatedAtColumnBlock' }
  ) | (
  ...
  { action?: (
    ...
    { actionListPage?: (
      { actionDateFormat?: string | null, taskDateFormat?: string | null, detailsMainTop?: Array<(
        ...
        & { __typename: 'ActionContactFormBlock' | 'ActionLeadParagraphBlock' | 'ActionLinksBlock' | 'ActionMergedActionsBlock' | 'ActionRelatedIndicatorsBlock' | 'ActionTasksBlock' }
      ) | (
        { id?: string | null, meta?: (
          { restricted?: boolean | null, hidden?: boolean | null }
          & { __typename?: 'FieldBlockMetaData' }
        ...
        { id?: string | null, heading?: string | null, helpText?: string | null, layout?: string | null, blocks?: Array<(
          ...
          { id?: string | null }
          & { __typename?: 'IndicatorBlock' | 'IndicatorGroupBlock' | 'IndicatorHighlightsBlock' | 'IndicatorShowcaseBlock' | 'IndicatorsColumnBlock' | 'IntegerBlock' | 'LargeImageBlock' | 'NameColumnBlock' | 'OrganizationColumnBlock' | 'PageChooserBlock' | 'PageLinkBlock' | 'PlanFilterBlock' | 'PrimaryOrganizationFilterBlock' | 'QuestionAnswerBlock' | 'QuestionBlock' | 'RawHTMLBlock' | 'RegexBlock' | 'RelatedIndicatorsBlock' | 'RelatedPlanListBlock' | 'ReportTypeFieldChooserBlock' }
        ) | (
          { id?: string | null }
        ...
        { id?: string | null, fieldLabel?: string | null, meta?: (
          { restricted?: boolean | null, hidden?: boolean | null }
          & { __typename?: 'FieldBlockMetaData' }
        ) | null }
        & { __typename: 'ActionDescriptionBlock' }
...
type ActionMainContentBlocksFragment_MyaY1oZyz3GdWk7xentbFzZuWumYhQHgP9q5QbHfzik_Fragment = (
  { id?: string | null, meta?: (
    { restricted?: boolean | null, hidden?: boolean | null }
    & { __typename?: 'FieldBlockMetaData' }
  ) | null }
...
type ActionMainContentBlocksFragment_ActionDescriptionBlock_Fragment = (
  { id?: string | null, fieldLabel?: string | null, meta?: (
    { restricted?: boolean | null, hidden?: boolean | null }
    & { __typename?: 'FieldBlockMetaData' }
  ) | null }
