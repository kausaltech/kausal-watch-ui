...
export const themeProp = exact({
  ...
  graphColors: exact({
    green010: string.isRequired,
    green030: string.isRequired,
    green050: string.isRequired,
    green070: string.isRequired,
    green090: string.isRequired,
    red010: string.isRequired,
    red030: string.isRequired,
    red050: string.isRequired,
    red070: string.isRequired,
    red090: string.isRequired,
    blue010: string.isRequired,
    blue030: string.isRequired,
    blue050: string.isRequired,
    blue070: string.isRequired,
    blue090: string.isRequired,
    yellow010: string.isRequired,
    yellow030: string.isRequired,
    yellow050: string.isRequired,
    yellow070: string.isRequired,
    yellow090: string.isRequired,
  }).isRequired,
