      ...
      <div className="comment-form-container">
        <div className="comment-form">
          ...
          <div className="comment-conditions">
            <small>
              Annetut kommentit julkaistaan
              {' '}
              <a href="http://www.hri.fi/fi/mita-on-avoin-data/">
                <span>avoimena datana</span>
                {' '}
              </a>
Helsingin kaupungin palvelussa
              {' '}
              <a href="http://creativecommons.org/licenses/by/4.0/deed.fi"><span>avoimella lisenssillä</span></a>
.
