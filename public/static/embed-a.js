...
(function () {
  ...
  var warn = function (message) {
    console.warn(
      KAUSAL_EMBED_NAME,
      ''.concat(KAUSAL_EMBED_MAJOR_SCRIPT_VERSION, ':'),
      message
    );
  };
  ...
  var addMessageListenerToWindow = function (iframe, embId) {
    window.addEventListener('message', function (event) {
      var _a, _b;
      if (
        ((_a = event.data) === null || _a === void 0 ? void 0 : _a.source) ==
          embId &&
        ((_b = event.data) === null || _b === void 0 ? void 0 : _b.height) !=
          null
      ) {
  ...
  var getEmbedUrl = function (el, specs, params) {
    ...
    if (
      ...
      throw new Error(
        'This script expects to be served from a '
          .concat(STATIC_PATH_NAME, '/')
          .concat(SCRIPT_NAME, ' path.')
      );
    }
  ...
  try {
    ...
    var _a = getEmbedSpecification(scriptElement),
      specs = _a[0],
      parameters = _a[1];
