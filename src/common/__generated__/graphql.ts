...
type ActionListFilter_V4nyI11nBoPkZ4tEAuNmGfJoUxW1A1MdeAtXiHnAyM_Fragment = (
  { field: string, id: string | null }
  & { __typename: 'PageChooserBlock' | 'PageLinkBlock' | 'PathsNodeSummaryBlock' | 'PathsOutcomeBlock' | 'PlanDatasetsBlock' | 'PlanFilterBlock' | 'PrimaryOrganizationFilterBlock' | 'QuestionAnswerBlock' | 'QuestionBlock' | 'RawHTMLBlock' | 'RegexBlock' | 'RelatedIndicatorsBlock' | 'RelatedPlanListBlock' | 'ReportComparisonBlock' | 'ReportTypeFieldChooserBlock' | 'ResponsiblePartiesColumnBlock' | 'RichTextBlock' | 'ScheduleContinuousColumnBlock' | 'SnippetChooserBlock' | 'StartDateColumnBlock' }
);

type ActionListFilter_JcBbaiYaIdtMKbekOvPqktr7lrQ659amyOIrPdr3rW8_Fragment = (
  { field: string, id: string | null }
...
type IndicatorListFilter_Dwv3OdkTkjLzz4Sw48GrYme4kQrBiZiXjabgmOvd4_Fragment = (
  { field: string, id: string | null }
...
type IndicatorListFilter_4jSv4a67HpvLrBgJ30S8J9MyxpLCpEygkQtrvrfEKc_Fragment = (
  { field: string, id: string | null }
...
type PledgeBodyFragment_1uhMlyByzKhwO1Ulc5a3A068iMpN7C8w70PvFi7Oc_Fragment = (
  { id: string | null, blockType: string }
  & { __typename: 'NameColumnBlock' | 'OrganizationColumnBlock' | 'PageChooserBlock' | 'PageLinkBlock' | 'PathsNodeSummaryBlock' | 'PathsOutcomeBlock' | 'PlanDatasetsBlock' | 'PlanFilterBlock' | 'PrimaryOrganizationFilterBlock' | 'QuestionBlock' | 'RawHTMLBlock' | 'RegexBlock' | 'RelatedIndicatorsBlock' | 'RelatedPlanListBlock' | 'ReportComparisonBlock' | 'ReportTypeFieldChooserBlock' | 'ResponsiblePartiesColumnBlock' | 'ResponsiblePartyFilterBlock' | 'ScheduleContinuousColumnBlock' | 'SnippetChooserBlock' }
);

type PledgeBodyFragment_Qd9gbaGsKnF0k57sxEg2NBrtJp3z0Go3ro6XpmhRt4_Fragment = (
  { id: string | null, blockType: string }
...
export type PledgeBodyFragmentFragment = PledgeBodyFragment_GxIqRAgfSioH07e0TsixWfsi2QkOwIkCdae4INdPti_Fragment | PledgeBodyFragment_Lrr2Fl8Se3u5PeLKw5dI21X2VgwGptdIrN1YaLxh00_Fragment | PledgeBodyFragment_DCiMtWTjVHcMJlWmTrxLDb0m3cl5Ha0YuNph9nWt8E_Fragment | PledgeBodyFragment_Pdyr2gV3MgosjzMZrQ9Lu7mfLp10GqOk7VjmsUf5p8_Fragment | PledgeBodyFragment_BOzjSxGUwODbNyVvVlEcNBzlQVxfDOqgmrBrkc_Fragment | PledgeBodyFragment_1uhMlyByzKhwO1Ulc5a3A068iMpN7C8w70PvFi7Oc_Fragment | PledgeBodyFragment_Qd9gbaGsKnF0k57sxEg2NBrtJp3z0Go3ro6XpmhRt4_Fragment | PledgeBodyFragment_LargeImageBlock_Fragment | PledgeBodyFragment_QuestionAnswerBlock_Fragment | PledgeBodyFragment_RichTextBlock_Fragment;
