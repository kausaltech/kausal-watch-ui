...
export type IndicatorGraphDataQuery = (
  { plan: (
    ...
    { id: string, name: string, timeResolution: IndicatorTimeResolution, showTrendline: boolean, showTotalLine: boolean, desiredTrend: IndicatorDesiredTrend | null, reference: string | null, minValue: number | null, maxValue: number | null, ticksCount: number | null, ticksRounding: number | null, valueRounding: number | null, dataCategoriesAreStackable: boolean, visualizationsRaw: Array<string>, organization: (
...
type StreamFieldFragment_Y9FkMnjdfD8bZgIzeYQeadDsuq7448PvmSq1T1qAg_Fragment = (
  { id: string | null, blockType: string, field: string }
...
type StreamFieldFragment_U30TnbSnAvsR07jeIzqfhLazi97Mfnxa9s5IoQmXtE_Fragment = (
  { id: string | null, blockType: string, field: string }
  & { __typename: 'StreamBlock' | 'StreamFieldBlock' | 'StructBlock' | 'TasksColumnBlock' | 'TimeBlock' | 'URLBlock' | 'UpdatedAtColumnBlock' }
);
...
export type IndicatorDetailsQuery = (
  { indicator: (
    { id: string, identifier: string | null, name: string, level: string | null, description: string | null, timeResolution: IndicatorTimeResolution, desiredTrend: IndicatorDesiredTrend | null, visualizationsRaw: Array<string>, organization: (
