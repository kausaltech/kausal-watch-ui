...
export type ActionFragmentFragment = (
  { id: string, identifier: string, name: string, viewUrl?: string, color: string | null, hasDependencyRelationships: boolean | null, manualStatusReason: string | null, completion: number | null, officialName: string | null, updatedAt: string, scheduleContinuous: boolean, startDate: any | null, endDate: any | null, order: number, indicatorsCount: number | null, hasIndicatorsWithGoals: boolean | null, status: (
    { id: string, identifier: string, name: string, color: string }
    & { __typename: 'ActionStatus' }
  ) | null, categories: Array<(
    { id: string, common: (
...
export type GetActionDetailsQuery = (
  { action: (
    { id: string, identifier: string, name: string, officialName: string | null, leadParagraph: string, description: string | null, completion: number | null, color: string | null, updatedAt: string, manualStatusReason: string | null, scheduleContinuous: boolean, startDate: any | null, endDate: any | null, dateFormat: ActionDateFormat | null, workflowStatus: (
      { matchingVersion: (
      ...
      { uuid: string, schema: (
        { uuid: string, timeResolution: DatasetSchemaTimeResolution, metrics: Array<(
          { unit: string }
        ...
        { uuid: string, value: number | null, date: any, dimensionCategories: Array<(
  ...
  { organization: (
    { id: string, name: string, abbreviation: string, distinctName: string | null, description: string, url: string, actionCount: number, contactPersonCount: number, classification: (
      ...
      { id: string, name: string, shortName: string | null, versionName: string, viewUrl: string | null, organization: (
        ...
        { id: string, identifier: string, name: string, officialName: string | null, completion: number | null, updatedAt: string, scheduleContinuous: boolean, startDate: any | null, endDate: any | null, order: number, attributes: Array<(
          { id: string, type: (
            { id: string, identifier: string, name: string, format: AttributeTypeFormat, unit: (
              { id: string, name: string, shortName: string | null }
              & { __typename: 'Unit' }
