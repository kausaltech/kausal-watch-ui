...
export type IndicatorDetailsQuery = (
  { planPage: (
    { title: string, id: string | null, urlPath: string }
    ...
    { title: string, id: string | null, urlPath: string, detailsMainTop: Array<{ __typename: 'IndicatorCategoryContentBlock' } | (
      { id: string | null, blockType: string, fieldLabel: string | null, fieldHelpText: string | null, field: string }
      & { __typename: 'IndicatorContentBlock' }
    )> | null, detailsMainBottom: Array<{ __typename: 'IndicatorCategoryContentBlock' } | (
      { id: string | null, blockType: string, fieldLabel: string | null, fieldHelpText: string | null, field: string }
      & { __typename: 'IndicatorContentBlock' }
    )> | null, detailsAside: Array<{ __typename: 'IndicatorCategoryContentBlock' } | (
      { id: string | null, blockType: string, fieldLabel: string | null, fieldHelpText: string | null, field: string }
      & { __typename: 'IndicatorContentBlock' }
    )> | null }
    & { __typename: 'IndicatorListPage' }
